...
{/* --- HERO SECTION --- */}
<header className="relative min-h-screen flex items-center px-4 md:px-12 overflow-hidden bg-black">
  ...
  {/* CONTENT */}
  <div className="relative z-10 max-w-7xl mx-auto w-full pt-20 flex flex-col lg:flex-row items-center justify-between gap-12">
    
    {/* LEFT SIDE: TEXT CONTENT */}
    <div className="w-full lg:w-1/2 text-center lg:text-left pointer-events-auto">
      
      <h1 className="text-4xl sm:text-5xl md:text-7xl font-light tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-gray-200 to-gray-500 leading-[1.1] font-montserrat uppercase will-change-transform">
        THE ONCHAIN
      </h1>

      <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter mb-8 text-white leading-none font-lastica uppercase drop-shadow-2xl">
        CONTEXT PROTOCOL
      </h1>
      
      <p className="text-lg md:text-xl text-gray-400 max-w-lg mx-auto lg:mx-0 leading-relaxed mb-12 font-sans tracking-wide">
